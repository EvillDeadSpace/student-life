                ...
                <div className='relative'>
                  ...
                  <div className='relative'>
                    ...
                    <button
                      ...
                      className='w-full pl-10 pr-10 py-3 border-2 border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-teal-500 bg-white dark:bg-gray-700 text-left text-gray-900 dark:text-white transition-all duration-300'
                    >
                      {selectedLocation || "Odaberite lokaciju"}
                    </button>
                    <svg
                    ...
                    >
                      <path
                        ...
                        strokeLinejoin='round'
                        strokeWidth={2}
                        d={isLocationOpen ? "M5 15l7-7 7 7" : "M19 9l-7 7-7-7"}
                      />
                    </svg>
                      ...
                      <div className='absolute z-10 w-full mt-1 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-xl shadow-lg max-h-48 overflow-y-auto'>
                        {locations.map((location) => (
                          <button
                            ...
                            className='w-full px-4 py-3 text-left hover:bg-gray-50 dark:hover:bg-gray-600 text-gray-900 dark:text-white transition-colors duration-200 first:rounded-t-xl last:rounded-b-xl'
                          >
                            {location}
                          </button>
                        ))}
